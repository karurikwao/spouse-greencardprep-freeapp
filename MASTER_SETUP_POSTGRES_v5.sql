...
CREATE INDEX idx_notification_events_broadcast_type
...
CREATE INDEX idx_notification_events_user_type
...
CREATE INDEX idx_sponsor_links_slug ON sponsor_links(slug);
CREATE INDEX idx_sponsor_links_active ON sponsor_links(is_active);

CREATE TABLE sponsor_link_clicks (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_sponsor_link_clicks_link_created
    ON sponsor_link_clicks(sponsor_link_id, created_at DESC);
CREATE INDEX idx_sponsor_link_clicks_user_created
